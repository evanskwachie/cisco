  ...
  <tbody>
    <tr>
      ...
      <td><?php 
        ...
        if (is_null($faculty_rmks)) {
          # code...
          $faculty_rmks = 'N/L';
        }

      echo $faculty_rmks ?>  </td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="exampleInputPassword1" placeholder="remarks" name="rmks" required><?php echo $faculty_rmks ?></textarea>
  </div>
  <div class="form-group">
    <label>Cleared</label>
